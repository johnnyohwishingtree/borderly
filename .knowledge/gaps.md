...
- Missing test coverage: 5 screens. Service test coverage complete — submission (#964), schema (#965), storage/keychain (#966), and forms (#967) now covered. WatermelonDB models/database untestable without native module setup. Stores and utils coverage added in #958. Test: track via test-suite skill runs. (audit-2026-03-26)
