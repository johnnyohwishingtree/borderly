...
- `src/services/automation/navigationController.ts` — 959 lines (audit-2026-03-24)
...
- `src/services/automation/elementDetector.ts` — 876 lines (audit-2026-03-24)
...
- `src/services/automation/domInteraction.ts` — 832 lines (audit-2026-03-24)
- `src/services/automation/uploadHandler.ts` — 771 lines (audit-2026-03-24)
...
- `src/services/submission/webviewController.ts` — 721 lines (audit-2026-03-24)
...
- `src/services/forms/formEngine.ts` — 646 lines (audit-2026-03-24)
...
- `src/services/automation/formFiller.ts` — 601 lines (audit-2026-03-24)
- `src/services/monitoring/portalMonitor.ts` — 589 lines (audit-2026-03-24)
- `src/services/forms/validators.ts` — 581 lines (audit-2026-03-24)
- `src/screens/wallet/AddQRScreen/AddQRScreen.tsx` — 580 lines (audit-2026-03-24)
- `src/services/submission/submissionValidator.ts` — 574 lines (audit-2026-03-24)
- `src/services/storage/keychain.ts` — 572 lines (audit-2026-03-24)
- `src/services/forms/autoFillLogic.ts` — 572 lines (audit-2026-03-24)
...
- `src/services/submission/submissionEngine.ts` — 540 lines (audit-2026-03-24)
