...
- Missing test coverage: 5 screens, services gap further reduced — submission (#964) and schema (#965) services now fully covered. Stores and utils coverage added in #958. Test: track via test-suite skill runs. (audit-2026-03-26)
