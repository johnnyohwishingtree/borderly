# Principle: Naming Conventions Enable Enforcement
...
- `policies/architecture/file-boundaries.md` (screen naming, hook naming)
- `policies/testing/e2e-testability.md` (testID suffixes, screen prefixes)
- `policies/state/hook-conventions.md` (`use<Domain><Action>` naming)
