...
- `.claude/rules/store-boundaries.md` — Screens -> Hooks -> Stores -> Services
- `.claude/rules/hook-extraction.md` — Extract business logic into hooks
- `.claude/rules/service-facade.md` — Facade when coordinating 4+ services
