...
- **Screen testIDs**: Read `src/screens/*/testIDs.ts` for per-screen element declarations
- **E2E screenshots**: Check `e2e/screenshots/` for visual reference of current screen state
