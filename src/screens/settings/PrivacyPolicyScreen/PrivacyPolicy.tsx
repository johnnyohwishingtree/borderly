...
export default function PrivacyPolicyScreen() {
  return (
    <ScrollView className="flex-1 bg-gray-50" testID="privacy-policy-screen">
      <View className="p-4 space-y-4">
        {/* Header */}
        <View className="mb-6">
          <Text className="text-2xl font-bold text-gray-900">Privacy Policy</Text>
          <Text className="text-sm text-gray-500 mt-1">Last updated: March 2026</Text>
        </View>
        ...
        <View className="bg-white p-4 rounded-xl border border-gray-200 mb-4">
          <Text className="text-lg font-semibold text-gray-900 mb-3">1. Data Storage</Text>
          ...
          <View className="space-y-1 mt-2">
            <Text className="text-sm text-gray-700">• Passport data is encrypted at rest</Text>
            <Text className="text-sm text-gray-700">• Encryption keys are biometric-protected</Text>
            <Text className="text-sm text-gray-700">• iCloud/Google backup is excluded for sensitive data</Text>
            <Text className="text-sm text-gray-700">• Trip data is stored in a local encrypted database</Text>
          </View>
        </View>

        {/* Section: Data Sharing */}
        <View className="bg-white p-4 rounded-xl border border-gray-200 mb-4">
          <Text className="text-lg font-semibold text-gray-900 mb-3">2. Data Sharing</Text>
          <Text className="text-sm text-gray-700 mb-2">
          ...
          <View className="space-y-1 mt-2">
            <Text className="text-sm text-gray-700">• No analytics services receive personal data</Text>
            <Text className="text-sm text-gray-700">• No crash reports include PII</Text>
            <Text className="text-sm text-gray-700">• No advertising or data brokers</Text>
          </View>
        </View>

        {/* Section: Clipboard */}
        <View className="bg-white p-4 rounded-xl border border-gray-200 mb-4">
          <Text className="text-lg font-semibold text-gray-900 mb-3">3. Clipboard Protection</Text>
        ...
        {/* Section: App Lock */}
        <View className="bg-white p-4 rounded-xl border border-gray-200 mb-4">
          <Text className="text-lg font-semibold text-gray-900 mb-3">4. App Lock</Text>
          <Text className="text-sm text-gray-700">
        ...
        <View className="bg-white p-4 rounded-xl border border-gray-200 mb-4">
          <Text className="text-lg font-semibold text-gray-900 mb-3">5. Government Portals</Text>
          <Text className="text-sm text-gray-700">
        ...
        <View className="bg-white p-4 rounded-xl border border-gray-200 mb-4">
          <Text className="text-lg font-semibold text-gray-900 mb-3">6. Family Profiles</Text>
          <Text className="text-sm text-gray-700">
        ...
        {/* Section: Your Rights */}
        <View className="bg-white p-4 rounded-xl border border-gray-200 mb-4">
          <Text className="text-lg font-semibold text-gray-900 mb-3">7. Your Rights</Text>
          <Text className="text-sm text-gray-700 mb-2">
            Because all data is stored locally on your device, you have full control:
          </Text>
          <View className="space-y-1 mt-2">
            <Text className="text-sm text-gray-700">• Export your data at any time from Settings</Text>
            <Text className="text-sm text-gray-700">• Delete all data from Settings → Data Management</Text>
            <Text className="text-sm text-gray-700">• Remove individual family member profiles</Text>
            <Text className="text-sm text-gray-700">• Uninstalling the app removes all data</Text>
          </View>
        </View>

        {/* Section: Contact */}
        <View className="bg-gray-100 p-4 rounded-xl mb-4">
          <Text className="text-base font-semibold text-gray-900 mb-2">Questions?</Text>
          <Text className="text-sm text-gray-700">
