  ...
  return (
    ...
    <ScrollView className="flex-1" testID="privacy-policy-screen">
      <View className="p-4 space-y-4">
        {/* Header */}
        <View className="mb-6">
          <Text className="text-sm text-tertiary">Last updated: March 2026</Text>
        </View>
        ...
        <View className="bg-surface p-4 rounded-xl border border-border-default mb-4">
          <Text className="text-lg font-semibold text-primary mb-3">1. Data Storage</Text>
          ...
          <View className="space-y-1 mt-2">
            <Text className="text-sm text-secondary">• Passport data is encrypted at rest</Text>
            <Text className="text-sm text-secondary">• Encryption keys are biometric-protected</Text>
            <Text className="text-sm text-secondary">• iCloud/Google backup is excluded for sensitive data</Text>
            <Text className="text-sm text-secondary">• Trip data is stored in a local encrypted database</Text>
          </View>
        </View>

        {/* Section: Data Sharing */}
        <View className="bg-surface p-4 rounded-xl border border-border-default mb-4">
          <Text className="text-lg font-semibold text-primary mb-3">2. Data Sharing</Text>
          <Text className="text-sm text-secondary mb-2">
          ...
          <View className="space-y-1 mt-2">
            <Text className="text-sm text-secondary">• No analytics services receive personal data</Text>
            <Text className="text-sm text-secondary">• No crash reports include PII</Text>
            <Text className="text-sm text-secondary">• No advertising or data brokers</Text>
          </View>
        </View>

        {/* Section: Clipboard */}
        <View className="bg-surface p-4 rounded-xl border border-border-default mb-4">
          <Text className="text-lg font-semibold text-primary mb-3">3. Clipboard Protection</Text>
        ...
        {/* Section: App Lock */}
        <View className="bg-surface p-4 rounded-xl border border-border-default mb-4">
          <Text className="text-lg font-semibold text-primary mb-3">4. App Lock</Text>
          <Text className="text-sm text-secondary">
        ...
        <View className="bg-surface p-4 rounded-xl border border-border-default mb-4">
          <Text className="text-lg font-semibold text-primary mb-3">5. Government Portals</Text>
          <Text className="text-sm text-secondary">
        ...
        <View className="bg-surface p-4 rounded-xl border border-border-default mb-4">
          <Text className="text-lg font-semibold text-primary mb-3">6. Family Profiles</Text>
          <Text className="text-sm text-secondary">
        ...
        {/* Section: Your Rights */}
        <View className="bg-surface p-4 rounded-xl border border-border-default mb-4">
          <Text className="text-lg font-semibold text-primary mb-3">7. Your Rights</Text>
          <Text className="text-sm text-secondary mb-2">
            Because all data is stored locally on your device, you have full control:
          </Text>
          <View className="space-y-1 mt-2">
            <Text className="text-sm text-secondary">• Export your data at any time from Settings</Text>
            <Text className="text-sm text-secondary">• Delete all data from Settings → Data Management</Text>
            <Text className="text-sm text-secondary">• Remove individual family member profiles</Text>
            <Text className="text-sm text-secondary">• Uninstalling the app removes all data</Text>
          </View>
        </View>

        {/* Section: Contact */}
        <View className="bg-surface-tertiary p-4 rounded-xl mb-4">
          <Text className="text-base font-semibold text-primary mb-2">Questions?</Text>
          <Text className="text-sm text-secondary">
