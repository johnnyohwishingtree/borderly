...
export const TRIP_LIST_IDS: Record<string, TestMeta> = {
  ...
  templatesNavButton: { id: 'templates-nav-button', type: 'button', zone: 'header' },
  ...
  useTemplateButton: { id: 'use-template-button', type: 'button', zone: 'scroll' },
  ...
  fabFromTemplateButton: { id: 'fab-from-template-button', type: 'button', zone: 'footer' },
