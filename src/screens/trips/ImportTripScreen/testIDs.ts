export const IMPORT_TRIP_IDS = {
  importTabPasteButton: { id: 'import-tab-paste-button', type: 'button' as const },
  importTabScanButton: { id: 'import-tab-scan-button', type: 'button' as const },
