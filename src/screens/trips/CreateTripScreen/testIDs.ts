export const CREATE_TRIP_IDS = {
  ...
  legFlightNumber: { id: 'leg-${index}-flight-number', type: 'Input' as const, dynamic: true as const },
  legAirlineCode: { id: 'leg-${index}-airline-code', type: 'Input' as const, dynamic: true as const },
  legArrivalAirport: { id: 'leg-${index}-arrival-airport', type: 'SearchableSelect' as const, dynamic: true as const },
  legAccommodationName: { id: 'leg-${index}-accommodation-name', type: 'AccommodationAutocomplete' as const, dynamic: true as const },
