export const TRIP_DETAIL_IDS = {
  goBackButton: { id: 'trip-detail-go-back-button', type: 'button' as const },
  duplicateTripButton: { id: 'duplicate-trip-button', type: 'button' as const },
