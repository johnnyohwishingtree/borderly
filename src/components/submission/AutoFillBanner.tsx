    ...
    <Animated.View style={{ opacity }} testID={testID ?? AUTOFILL_BANNER_IDS.container.id}>
      ...
      >
        ...
        <View className="flex-row items-center px-4 py-2.5">
          <Text
            className={`flex-1 text-sm ${messageText} font-medium`}
        ...
        {isExpanded && hasResults && (
          ...
          >
            {filledResults.length > 0 && (
              <>
                <Text className={`text-xs ${messageText} font-semibold mb-1`}>
            ...
            {failedResults.length > 0 && (
              <>
                <Text className="text-xs text-amber-900 font-semibold mt-1.5 mb-1">
