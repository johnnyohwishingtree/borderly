...
test('SmartForm screen exists', () => {
  expect(existsSync(
    resolve(ROOT, 'src/screens/forms/SmartFormScreen'),
  )).toBe(true);
});

test('SmartForm shows fields grouped by country', () => {
