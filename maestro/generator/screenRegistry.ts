...
export const SCREENS: Record<string, ScreenSpec> = {
  Welcome: {
    ...
    waitFor: 'Fill Once, Travel Everywhere',
    fields: [],
    alerts: [],
    actionButtons: [
      { testID: 'get-started-button', label: 'Get Started', description: 'Begin onboarding' },
      { testID: 'skip-button', label: 'Skip', description: 'Skip to tutorial' },
    ],
  ...
  Tutorial: {
    ...
    alerts: [],
    actionButtons: [
      { testID: 'next-button', label: 'Next', description: 'Next tutorial step' },
      { testID: 'skip-button', label: 'Skip', description: 'Skip tutorial' },
    ],
  ...
  PassportScan: {
    ...
    fields: [
      ...
      { testID: 'nationality-select', label: 'Nationality', componentType: 'SearchableSelect', required: true, exampleValue: 'USA' },
      { testID: 'date-of-birth-input', label: 'Date of Birth', componentType: 'DatePickerField', required: true },
      { testID: 'gender-select', label: 'Gender', componentType: 'Select', required: true },
      { testID: 'passport-expiry-input', label: 'Passport Expiry', componentType: 'DatePickerField', required: true },
      { testID: 'issuing-country-select', label: 'Issuing Country', componentType: 'SearchableSelect', required: true, exampleValue: 'USA' },
    ],
    alerts: [
      { title: 'Profile Saved', buttons: ['Continue'], happyPathButton: 'Continue', trigger: 'save-profile-button', outcome: 'Navigate to ConfirmProfile' },
    ],
    actionButtons: [
      { testID: 'scan-passport-button', label: 'Scan Passport', description: 'Open camera for MRZ scan' },
      { testID: 'demo-scan-button', label: 'Use Demo Data', description: 'Fill with sample passport data' },
      { testID: 'manual-entry-button', label: 'Enter Manually', description: 'Show manual entry form' },
      { testID: 'save-profile-button', label: 'Save & Continue', description: 'Save profile and proceed' },
    ],
    navigatesTo: ['ConfirmProfile'],
    notes: [
      'Three entry modes: camera scan, demo data, manual entry.',
      'Demo scan fills all fields with sample data and auto-saves.',
  ...
  AddCompanions: {
    ...
    waitFor: 'Travel Companions',
    fields: [],
    alerts: [],
    actionButtons: [
      { testID: 'add-companion-button', label: 'Add Companion', description: 'Add a family member' },
      { testID: 'skip-companions-button', label: 'Skip for Now', description: 'Continue without adding companions' },
      { testID: 'continue-with-companions-button', label: 'Continue', description: 'Proceed after adding companions' },
    ],
    navigatesTo: ['BiometricSetup'],
    notes: ['Optional step — can skip without adding anyone.'],
  },
  ...
  TripList: {
    ...
    actionButtons: [
      ...
      { testID: 'create-trip-fab', label: '+', description: 'FAB to create trip (shown when trips exist)' },
    ],
